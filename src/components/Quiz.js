...
function Quiz() {
    ...
    return (
        <div className="quiz">
            {showResult ? (
                <Result totalQuestions={questions.length} answeredCount = {answeredCount}/>
            ) : (
                <div>
                    <div className="timer">
                    ...
                    <div className="progress">
                        <p>
                             Answered Questions: {answeredCount} out of  {questions.length}
                        </p>
                        <div className="answered-count">
                            <div
                                className="answers-counting"
                                style={{
                                    width: `${(answeredCount / questions.length)}%`,
                                }}
                            ></div>
                        </div>
                    </div>
                    ...
                    <button className="submit-button"
                        ...
                        disabled={timeLeft === 0 || isTimeDone}
                    >
                        Submit
                    </button>
                </div>
